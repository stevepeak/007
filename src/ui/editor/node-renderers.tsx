...
export const NODE_TYPES = {
  ...
  [editorTypeForKind('decision')]: DecisionNodeRenderer,
  ...
  [editorTypeForKind('passthrough')]: PassthroughNodeRenderer,
  [editorTypeForKind('text')]: TextNodeRenderer,
  [editorTypeForKind('transform')]: TransformNodeRenderer,
